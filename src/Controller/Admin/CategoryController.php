...
use App\Form\Type\Entity\CategoryType;
...
class CategoryController extends AbstractController
{
    ...
    {
        $category = $this->em->getRepository(Category::class)->findAllPaginated($page, 10);
    ...
    #[Route(path: "/api/admin/massDelete/category", name: 'app_admin_mass_delete_category', methods: ['DELETE'], defaults: [
        '_api_operation_name' => '_api_/api/admin/massDelete/category',
    ])]
